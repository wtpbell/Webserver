...
SRCS_HTTP	:= $(addprefix http/, HTTPMessage.cpp HTTPParser.cpp HTTPUtils.cpp HTTPRequest.cpp \
				HTTPValidator.cpp HTTPStatus.cpp)
...
TEST_SRCS	:= catch_amalgamated.cpp test_sharedfd.cpp test_socket.cpp Client.cpp test_server.cpp test_epollmanager.cpp test_logger.cpp \
				test_lexer.cpp test_parser.cpp test_http_paths.cpp test_http_parser.cpp test_http_validator.cpp test_integrate_parser_validator.cpp
